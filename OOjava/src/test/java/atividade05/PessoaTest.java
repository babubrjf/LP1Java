...
//        pessoa.setPeso(49f);
//        pessoa.setAltura(1.60f);
//        assertEquals(19.1, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcMulherAcimaDoPeso() {
        // Imc 25.8
//        pessoa.setPeso(55.5f);
//        pessoa.setAltura(1.70f);
//        assertEquals(25.8, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcMulherAcimaPesoIdeal() {
        // Imc 27.3
//        pessoa.setPeso(74.5f);
//        pessoa.setAltura(1.65f);
//        assertEquals(27.3, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcMulherObesa() {
        ...
        pessoa.setAltura(1.70f);
        assertEquals(32.3, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcHomemPesoNormal() {
        // Imc 20.7
//        pessoa.setPeso(67.3f);
//        pessoa.setAltura(1.80f);
//        assertEquals(20.7, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcHomemAcimaDoPeso() {
        // Imc 26.4
//        pessoa.setPeso(85.6f);
//        pessoa.setAltura(1.80f);
//        assertEquals(26.4, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcHomemAcimaPesoIdeal() {
        // Imc 27.8
//        pessoa.setPeso(90.1f);
//        pessoa.setAltura(1.80f);
//        assertEquals(27.8, pessoa.calculoImc(), 0.1f);
    ...
    public void deveCalcularImcHomemObeso() {
        ...
        pessoa.setPeso(101);
        pessoa.setAltura(1.80f);
        assertEquals(31.1, pessoa.calculoImc(), 0.1f);
